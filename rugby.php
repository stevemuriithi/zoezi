...
<body>
   ...
   <h2 class="title">RUGBY</h2>
             ...
             <div class="row">
                <div class="col-2">
              <div >        <!--to fetch and retrieve respective values from database-->
                    <?php
                          while ($row = mysqli_fetch_assoc($result))
                          {
                            if ($row["Id"] == 1) {
                            echo 
                            "<a href=leg_curl.php?ID=".$row['Id'].">
                            <img src='https://udon.ads.ntu.ac.uk/web/Misc2022/N0891597/fyp/images/workouts/rugby/".$row['Image']."' height=300px width=300px>  ".$row['Name'].'';
                          }
                          else 
                            echo 
