...
$sql = "SELECT * FROM login WHERE LEVEL='member'";
...
<body>
   ...
   <h2 class="title">EDIT USER ACCOUNTS</h2>
    ...
    while ($row=mysqli_fetch_assoc($result)){
        echo 
            "<p7>username:</p7>"."<p8>".$row["username"]."</p8>".
            "<br><p7>password:</p7>"."<p8>".$row["password"]."<p8>".
            
            "<br><a href=delete-user.php?ID=".$row["ID"]."button class='btn2'> Delete user</button></a>".
            "<br><a href=update-user.php?row_ID=".$row["ID"]."button class='btn2'>Update user</a><br><br>";
    }
    ?>
           </div> 
</div>
