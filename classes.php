...
<body>
   ...
   <div class="header">
     ...
     <h1 >Enjoy a variety of classes from your home</h1><br><br><br>
<div class="small-container">
   <div class="row">
               <div class="col-2">
                   <a href="#"><img 
                    src="images/vidd.jpeg"height=600px width=300px></a>
                </div>
                <div class="col-2">
                   <a href="#"><img 
                    src="images/vidd2.jpeg"height=600px width=300px></a>
                </div>
                <div class="col-2">
                   <a href="#"><img 
                    src="images/vidd3.jpeg"height=600px width=300px></a>
                </div>
                <div class="col-2">
                   <a href="#"><img 
                    src="images/vidd4.jpeg"height=600px width=300px></a>
                </div>
            </div>
        </div>
<br><br><br><br><br><br> <br><br><br><br><br><br>
