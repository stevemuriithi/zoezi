<?php
    ...
    $sql = "SELECT * FROM exercises WHERE muscle='legs' AND type='h' ";
...
<body>
   ...
   <h2 class="title">LEGS HOME WORKOUT</h2>
              ...
              <div >        
                    <?php
                          while ($row = mysqli_fetch_assoc($result))
                          {
                            ...
                            <img src='https://udon.ads.ntu.ac.uk/web/Misc2022/N0891597/fyp/images/workouts/legs/home/".$row['Image']."' height=300px width=300px>  ".$row['Name'].'';
                          }
                          else 
                            echo 
