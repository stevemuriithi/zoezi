...
<body>
   ...
   <h2 class="title">EDIT USER WORKOUTS</h2>
    ...
    while ($row=mysqli_fetch_assoc($result)){
        echo 
            "<p7>Name:</p7>"."<p8>".$row["Name"]."</p8>".
            "<br><p7>Image:</p7>"."<p8>".$row["Image"]."<p8>".
            "<br><p7>Muscle:</p7>"."<p8>".$row["Muscle"]."<p8>".
            "<br><p7>Type:</p7>"."<p8>".$row["type"]."<p8>".
            
            "<br><a href=delete-workout.php?ID=".$row["Id"]."button class='btn2'> Delete workout</button></a>".
            "<br><a href=update-user.php?ID=".$row["Id"]."button class='btn2'>Update workout</a><br><br>";
    }
    ?>
           </div>
</div>
