<?php
    ...
    $sql = "SELECT * FROM chest WHERE Id =1";
...
<body>
 ...
 <!--exercise-->   
   <div class="small-container single-product">
    <div class="row">
        <div class="col-2">
            <img src="images/workouts/chest/bench_press_barbell01.png" width="100%" id="ProductImg"> 
            <div class="small-img-row">
               <div class="small-img-col">
                   <img src="images/workouts/chest/bench_press_barbell01.png" class="small-img" width="100%">
               </div>
               <div class="small-img-col">
                   <img src="images/workouts/chest/bench_press_barbell2.png" class="small-img" width="100%">
               </div>
            </div>            
        </div>
        <div class="col-2">
